export default {
  ...
  run: async (conn, m, { Func }) => {
    try {
      ...
      if (!rawUrl.startsWith('http')) return m.reply('URL harus diawali dengan http:// atau https://')
      ...
      if (!res || res === 'Error') throw new Error('Custom alias sudah dipakai orang lain. Coba nama lain.')
