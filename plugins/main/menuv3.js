        ...
        interactiveMessage: {
          ...
          nativeFlowMessage: {
            buttons: [
              ...
              {
                name: 'quick_reply',
                buttonParamsJson: JSON.stringify({ display_text: 'Menu Bot', id: '.menu' })
              },
              {
                name: 'quick_reply',
                buttonParamsJson: JSON.stringify({ display_text: 'yth.Z3PH', id: 'owner' })
              },
              {
                name: 'cta_url',
                buttonParamsJson: JSON.stringify({ display_text: 'Saluran', url: 'https://whatsapp.com/channel/0029VbCbo6V89inbHHxprE19' })
              }
            ],
