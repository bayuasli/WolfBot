        ...
        buttons: [{
          ...
          buttonParamsJson: JSON.stringify({
            payment_settings: [{
              ...
              pix_static_code: { merchant_name: 'bxx', key: ownername, key_type: 'PHONE' }
            }]
          })
        }]
      }
...
export const gif = {
  key: { participant: '0@s.whatsapp.net', remoteJid: 'status@broadcast' },
  message: { videoMessage: { title: botname, h: wm, seconds: '359996400', gifPlayback: 'true', caption: ownername } }
}

export const gc = {
  key: { participant: '0@s.whatsapp.net', remoteJid: '0@s.whatsapp.net' },
  message: { groupInviteMessage: { groupJid: '120363427920837478@g.us', inviteCode: 'm', groupName: wm, caption: ownername } }
}

export const video = {
  key: { fromMe: false, participant: '0@s.whatsapp.net', remoteJid: 'status@broadcast' },
  message: { videoMessage: { title: botname, h: wm, seconds: '359996400', caption: pushname } }
}
...
export const order = {
  key: { remoteJid: 'status@broadcast', fromMe: false, id: 'BAE5C9E3C9A6C8D6', participant: '0@s.whatsapp.net' },
  message: {
    orderMessage: {
